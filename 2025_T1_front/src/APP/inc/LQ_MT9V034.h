...
#define CAMERA_CONTRAST 0x11c7 // 龙邱默认0x01c7

// 自动曝光开关 默认打开  设置为0 关闭自动曝光
#define CAMERA_AUTO_EXPOSURE 0 // 龙邱默认1

// 自动曝光模式下 亮度 调节范围 1-64
#define CAMERA_AUTO_EXPOSURE_BRIGHTNESS 64 // 龙邱默认50
...
// 曝光时间越长 图像越亮
#define CAMERA_MAX_EXPOSURE_TIME 1000 // 龙邱默认300
#define CAMERA_MIN_EXPOSURE_TIME 1

// 非自动曝光模式下 可以调节曝光时间来调节图像整体亮度 调节范围 0–32765
// 注意 当帧率过高时 如果设置的曝光时间过长 帧率可能会自适应下调
// 曝光时间越长 图像越亮
#define CAMERA_EXPOSURE_TIME 380 // 龙邱默认160
...
#define CAMERA_AUTO_EXPOSURE_BRIGHTNESS 1 // 龙邱默认50，自动曝光模式下 亮度 调节范围 1-64
